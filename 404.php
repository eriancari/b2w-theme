...
?>
	<section class="feature-image feature-image-default-alt" data-type="background" data-speed="2">
		<h1 class="page-title">Bummer! That page doesn't exist.</h1>
	</section>
				...
				<div class="error-404 not-found">
					<div class="page-content">
						...
						<div class="resource-row clearfix">
							...
							?>
							<div class="resource">
								<img src="<?=$resource_img['url']; ?>" alt="<?=$resource_img['alt']; ?>" />
						...
						================================================== -->
						<h3>Archives</h3>
						<p>You can always sort through our archieves...</p>

						<?php the_widget('WP_Widget_Archives', 'title=Our archieves','before_title=<h4 class="widget-title">&after_title=</h4>'); ?>

						<p>..or, just head back to the <a href="<?php echo home_url(); ?>">homepage</a>.</p>
					</div>
				</div>
			</main>
			<!-- SIDEBAR
